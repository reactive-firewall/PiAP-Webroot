...
USER_ID=$(/srv/dsauth.py -C -f /srv/PiAP/files/db/passwd -X $(sudo -u pocket-www head -n 1 /srv/PiAP/files/db/pepper) -U ${CN_USERNAME} | grep -vF "None" )
...
sudo -u pocket-admin /opt/PiAP/sbin/autosign_client.bash ${CN_USERNAME:-client} 2>/dev/null > /dev/null || EXIT_CODE=2
...
chown pocket-admin:pocket-www ${LINK_STUB_PATH}.p* 2>/dev/null > /dev/null || true
