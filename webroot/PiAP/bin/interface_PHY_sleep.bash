...
#
# PYH_IFACE - The interface that is hot-swapable usualy physical ethernet is eth0
PHY_IFACE="${1:-eth0}"

if [[ ( -n $(ip addr show ${PHY_IFACE} | fgrep 'NO-CARRIER' ) ) ]] ; then
	ifdown ${PHY_IFACE} 2>/dev/null ; EXIT_CODE=$? ; wait ;
fi
exit ${EXIT_CODE:-0} ;
